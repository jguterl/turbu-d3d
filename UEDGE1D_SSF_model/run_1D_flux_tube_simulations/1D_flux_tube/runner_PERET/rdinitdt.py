...
i_stor = 0
nfe_tot = 0
savefn = "/fusion/projects/boundary/peretm/1D_flux_tube/runner_PERET/savedt.hdf5"  # name of hdf5 savefile written every timestep
...
bbb.itermx = 20   #..zml
bbb.tstor_s = 1e-6		# beginning time for storing solution
bbb.tstor_e = 1e-2		# ending time for storing solution
bbb.n_stor = 300		    # number of linearly spaced storage points
