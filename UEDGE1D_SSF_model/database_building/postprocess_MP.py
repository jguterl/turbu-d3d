...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul  5 20:44:15 2022
...
for k in range(len(data)):
    ...
    database['L_leg'][k] = data[k]['postprocess']['state'][3][0]['com.zm'][database['i_t'][k],1,0]-data[k]['postprocess']['state'][3][0]['com.zm'][database['i_x'][k],1,0]
    database['ncore'][k] = data[k]['params']['ncore']
    database['pcore'][k] = data[k]['params']['pcore']
    database['Prad_div'][k] = integrate.simps(data[k]['postprocess']['power'][3][0]['bbb.prad'][database['i_x'][k]:database['i_t'][k],1],data[k]['postprocess']['state'][3][0]['com.zm'][database['i_x'][k]:database['i_t'][k],1,0])#/ee
...
np.save('/fusion/projects/boundary/peretm/AI_database/UEDGE1D_database_MP_fluxtube.npy', database, allow_pickle=True)
